...
write.csv(result, file.path(out_dir, "new_av365_sum_filter_rdrobust300.csv"), row.names = FALSE)
write.csv(count_result, file.path(out_dir, "new_av365_sum_filter_counts.csv"), row.names = FALSE)
...
writeLines(tex_lines, file.path(out_dir, "new_av365_sum_filter_rdrobust300.tex"))
