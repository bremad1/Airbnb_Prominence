...
all_path <- file.path("results", paste0("codex_panel_b_balanced_all_", stamp, ".csv"))
pass_path <- file.path("results", paste0("codex_panel_b_balanced_pass_", stamp, ".csv"))
near_path <- file.path("results", paste0("codex_panel_b_balanced_near_", stamp, ".csv"))
